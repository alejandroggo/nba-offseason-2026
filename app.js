...
const TEAM_VIDEOS = {
  ...
  'Indiana Pacers':         'zhQ2QfZuj8c',
  'Los Angeles Clippers':   '1W4iBXrN86A',
  'Los Angeles Lakers':     'z006hUGp8NM',
  'Memphis Grizzlies':      'oSUARzUVWxE',
...
const TEAM_ARTICLES = {
  ...
  'Minnesota Timberwolves': 'https://www.nbaconcontexto.com/p/minnesota-timberwolves-previa-del',
  'Boston Celtics':         'https://www.nbaconcontexto.com/p/boston-celtics-previa-del-verano',
  'Denver Nuggets':         'https://www.nbaconcontexto.com/p/denver-nuggets-previa-del-verano',
  'Los Angeles Lakers':     'https://www.nbaconcontexto.com/p/los-angeles-lakers-previa-del-verano',
  'San Antonio Spurs':      'https://www.nbaconcontexto.com/p/san-antonio-spurs-previa-del-verano',
  'Detroit Pistons':        'https://www.nbaconcontexto.com/p/detroit-pistons-previa-del-verano',
  ...
  'New York Knicks':        'https://www.nbaconcontexto.com/p/los-knicks-campeones-y-el-modelo',
};
...
const _OPTION_DEADLINES = {
  ...
  'mouhamed gueye':          '2026-06-25', 'jonathan kuminga':       '2026-06-29',
...
const _TX_DATE_OVERRIDES = {
  ...
  'kentavious caldwell-pope': '2026-06-19',
  "d'angelo russell":         '2026-06-19',
  'mouhamed gueye':           '2026-06-25',
  'mark williams':            '2026-06-25',
  'chucky hepburn':           '2026-06-25',
  ...
  'ziaire williams':          '2026-06-28',
  'fred vanvleet':            '2026-06-29',
  'draymond green':           '2026-06-29',
  'jd davison':               '2026-06-29',
  'j.d. davison':             '2026-06-29',
  'gg jackson':               '2026-06-29',
  'gg jackson ii':            '2026-06-29',
  'keshad johnson':           '2026-06-29',
  'jonathan isaac':           '2026-06-27',
  'tolu smith iii':           '2026-06-29',
...
function openPlayerDrawer(playerName, pushHistory = true) {
  ...
  if (bioBefore) {
    ...
    if (bioBefore.univ && !allDraftData.length) bioHtml += drawerRow('Universidad/Origen', esc(bioBefore.univ));
...
function openTeamView(teamName, pushHistory = true) {
  ...
  if (_summaryEl) {
    _summaryEl.innerHTML = _summarySegs.length
      ? _summarySegs.map(s => `<span class="tv-sum-item"><span class="tv-sum-num">${s.n}</span> ${esc(s.label)}</span>`).join('<span class="tv-sum-sep">·</span>')
      : '';
  }
